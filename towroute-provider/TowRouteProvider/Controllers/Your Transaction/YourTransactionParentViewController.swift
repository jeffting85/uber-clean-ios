...
class YourTransactionParentViewController: ButtonBarPagerTabStripViewController {
    ...
    override func viewDidLoad() {
        ...
        settings.style.selectedBarBackgroundColor = UIColor(hexString: "3B5998")!
        settings.style.buttonBarItemFont = .boldSystemFont(ofSize: 14)
        settings.style.selectedBarHeight = 2.0
        settings.style.buttonBarMinimumLineSpacing = 0
        settings.style.buttonBarItemTitleColor = UIColor(hexString: "3B5998")!
        ...
        changeCurrentIndexProgressive = { [weak self] (oldCell: ButtonBarViewCell?, newCell: ButtonBarViewCell?, progressPercentage: CGFloat, changeCurrentIndex: Bool, animated: Bool) -> Void in
            ...
            newCell?.label.textColor = UIColor(hexString: "3B5998")!
        }
