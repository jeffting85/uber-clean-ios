...
//addMenu()
    ...
    @IBAction func shareact(_ sender: Any) {
        let c = "Hello I am using TOWROUTE PROVIDER. Its an amazing app. Signup using below referral code and enjoy job. My Referral Code:"
        let text = "\(c) \(invitecodetxt.text!)"
