...
class YourjobUpcomingViewController: UIViewController,IndicatorInfoProvider,TextFieldDelegate,UITableViewDelegate,UITableViewDataSource,MFMessageComposeViewControllerDelegate  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.bookingnum.text = "Booking No# ".localiz() + "\(dict["booking_id"]!)"
        
        cell.customername.text = "Name :".localiz() + "\(dict["customer_name"]!)"  //dict.object(forKey: "driver_name") as? String
        cell.customercontact.text = "Phone :".localiz() + "\(dict["customer_phone_number"]!)" //dict.object(forKey: "driver_phone_number") as? String
               print("chkcell.customercontact.text\(cell.customercontact.text)")
               cus_number = "\(dict["customer_phone_number"]!)"
       ...
       // cell.date.text = dict.object(forKey: "job_date") as? String
        ...
        if status == "14" {
            ...
            cell.status.text = "Job Cancelled".localized
            ...
            cell.status.isHidden = false
            cell.statuslab.isHidden = false
            cell.status.text = "Driver has Cancelled Job".localized
    ...
    @objc func call(sender: UIButton){
        ...
        if let url = URL(string: "tel://\(cus_number)"), UIApplication.shared.canOpenURL(url) {
            if #available(iOS 10, *) {
    ...
    @objc func message(sender: UIButton){
        ...
        // controller.body = "Message Body"
            print("chkdriver_mob_no\(cus_number)")
        controller.recipients = ["\(cus_number)"]
...
class upcomingJobsCell: UITableViewCell {
    @IBOutlet weak var message: UIButton!
       ...
       @IBOutlet var customername: UILabel!
        @IBOutlet var customercontact: UILabel!
