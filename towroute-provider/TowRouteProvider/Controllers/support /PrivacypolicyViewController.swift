            ...
            if case let data as NSArray = response?["data"]{
                ...
                for descri in data{
                                      ...
                                      else
                                      {
                                        ...
                                        self.label.attributedText =  desvalue.convertHtmlToAttributedStringWithCSS(font: UIFont(name: "Arial", size: 16), csscolor: "black", lineheight: 5, csstextalign: "justify")
                                      }
                }
            }
