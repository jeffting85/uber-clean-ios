            ...
            if case let data as NSArray = response?["data"]{
                ...
                for descri in data{
                    ...
                    else
                    {
                        ...
                        self.about.attributedText =  desvalue.convertHtmlToAttributedStringWithCSS1(font: UIFont(name: "Arial", size: 16), csscolor: "black", lineheight: 5, csstextalign: "justify")
                    }
