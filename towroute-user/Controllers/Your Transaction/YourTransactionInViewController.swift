//
//  YourTransactionInViewController.swift
//  TowRoute User
//
...
class YourTransactionInViewController: UIViewController,IndicatorInfoProvider,UITableViewDelegate,UITableViewDataSource {
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Money In".localized)
    }
