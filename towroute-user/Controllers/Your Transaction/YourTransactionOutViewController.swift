//
//  YourTransactionOutViewController.swift
//  TowRoute User
//
...
class YourTransactionOutViewController: UIViewController,IndicatorInfoProvider,UITableViewDelegate,UITableViewDataSource {
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Money Out".localized)
    }
        ...
        APIManager.shared.transaction(params: params as [String : AnyObject]) { (response) in
            ...
            if case let msg as String = response?["message"], msg == "Unauthenticated." {
                ...
                for det in details {
                    ...
                    let dict = det as! NSDictionary
                    
                    let transaction_type = dict.object(forKey: "transaction_type") as! String
                    
                    if transaction_type == "debit" || transaction_type == "debit "{
                        
                        self.transactionarray.add(dict)
